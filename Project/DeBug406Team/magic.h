...
/* wzuwRXAlVO639rUJ */
/* 正常速度PID的各项参数 */
#define KpHightSpeed      (float)117.763
#define KiHightSpeed      (float)12
#define KdHightSpeed      (float)25.5
/* 正常巡线速度PWM值 */
#define HightSpeedPID_PWM (float)0.21
...
#define KpLowSpeed        (float)104.763
...
/* 下长坡车辆巡线用的PWM值影响下桥速度 */
#define DownBridgePWM        (float)0.06
...
/* 过桥惯性导航PID的各项参数 */
#define KpBridge          (float)0.33
#define KiBridge          (float)0.005
#define KdBridge          (float)0.02
